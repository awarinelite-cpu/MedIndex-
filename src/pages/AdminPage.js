...
const EDITABLE_FIELDS = [
  ...
  { key: 'nafdac_no',               label: 'NAFDAC No.',              type: 'text',     required: false },
  { key: 'overview',                label: 'Overview',                type: 'textarea', required: false },
  { key: 'indications',             label: 'Indications',             type: 'textarea', required: true  },
  { key: 'therapeutic_note',        label: 'Therapeutic Note',        type: 'textarea', required: false },
  { key: 'adult_dose',              label: 'Adult Dose',              type: 'textarea', required: false },
  { key: 'child_dose',              label: 'Child Dose',              type: 'textarea', required: false },
  { key: 'renal_dose',              label: 'Renal Dose',              type: 'textarea', required: false },
  { key: 'administration',          label: 'Administration',          type: 'textarea', required: false },
  { key: 'nstg_recommendations',    label: 'NSTG Recommendations',    type: 'textarea', required: false },
  { key: 'pharmacology',            label: 'Pharmacology',            type: 'textarea', required: false },
  { key: 'advice_to_patients',      label: 'Advice to Patients',      type: 'textarea', required: false },
  { key: 'contraindications',       label: 'Contra-indications',      type: 'textarea', required: false },
  { key: 'precautions',             label: 'Precautions',             type: 'textarea', required: false },
  { key: 'pregnancy_lactation',     label: 'Pregnancy & Lactation',   type: 'textarea', required: false },
  { key: 'interaction',             label: 'Interaction',             type: 'textarea', required: false },
  { key: 'adverse_effect',          label: 'Adverse Effect',          type: 'textarea', required: false },
  { key: 'nursing_action',          label: 'Nursing Action',          type: 'textarea', required: false },
  { key: 'pharmacovigilance',       label: 'Pharmacovigilance',       type: 'textarea', required: false },
  { key: 'product_description',     label: 'Product Description',    type: 'textarea', required: false },
  { key: 'storage_recommendations', label: 'Storage Recommendations', type: 'textarea', required: false },
  { key: 'pack_size_price',         label: 'Pack Size & Price',       type: 'text',     required: false },
